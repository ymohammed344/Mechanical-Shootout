...
namespace Mkey
{
    ...
    public class CBuffers
    {
        ...
        internal void CreateUvMap(int width, int height, int2_mk[] uvs, int extPixels)
        {
            ReleaseBuffer(uvMap);
            ...
            int pos = 0;
            int2_mk uvBottomLeft, uvTopRight, uvBottomLeftInt, uvTopRightInt, dXY;
            int s, i, j;
            float yi, xi, xr, yr;
        ...
        /// <param name="height"></param>
        /// <param name="uvs"></param>
        internal void CreateUvMap(int width, int height, int2_mk[] uvs)
        {
            ReleaseBuffer(uvMap);
            int size = width * height;
            uvMap = new ComputeBuffer(size, 8);
            Vector2[] uvMapArr = new Vector2[size];
            int pos = 0;
            int2_mk uvBottomLeftInt, uvTopRightInt, dXY;
            float yi, xi, xr, yr;
            int s, i, j;
            for (s = 0; s < uvs.Length; s += 3)
            {
