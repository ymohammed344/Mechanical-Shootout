...
namespace Mkey
{
    ...
    public class GPUWorker
    {
        ...
        /// <param name="outText"></param>
        /// <param name="color"></param>
        public void GPUFill_R8(int2_mk size, ref RenderTexture outText, float color)
        {
            if (outText != null && outText.IsCreated()) outText.Release();
        ...
        /// <param name="outText"></param>
        /// <param name="color"></param>
        public void GPUFill(int2_mk size, ref RenderTexture outText, Color color)
        {
            if (outText != null && outText.IsCreated()) outText.Release();
        ...
        /// <param name="inputText"></param>
        /// <param name="outText"></param>
        public void GPUCopyTextureUV(int2_mk[] inputUV, int2_mk[] outputUV, int2_mk outTextSize, Texture inputText, ref RenderTexture outText)
        {
        ...
        public void GPUCombiner(FaceOptions fOptions, CBuffers buffers)
        {
            ...
            EShader.SetInt("width", TextSize.Width);
            EShader.SetInt("height", TextSize.Height);
            EShader.SetInt("aSize", Options.contourBufferLength); // 512
        ...
        public void GPURenderBevelInside_R8(Texture inputText, ComputeBuffer dtBuffer, ref RenderTexture outTextLight, ref RenderTexture outTextShadow, BevelOptions bevelOptions)
        {
            ...
            EShader.SetInt("width", TextSize.Width);
            EShader.SetInt("height", TextSize.Height);
            EShader.SetInt("aSize", Options.contourBufferLength); // fBInputA.length
    ...
    [Serializable]
    public struct int2_mk
    {
        public int X;
        public int Y;
        public int2_mk(int x, int y)
        {
            X = x;
            Y = y;
        }
        ...
        public static int2_mk operator +(int2_mk a, int2_mk b)
        {
            int2_mk i = new int2_mk();
            i.X = a.X + b.X;
            i.Y = a.Y + b.Y;
            return i;
        }
        ...
        public static int2_mk operator /(int2_mk a, int b)
        {
            int2_mk i = new int2_mk();
            i.X = a.X / b;
            i.Y = a.Y / b;
        ...
        public static bool operator ==(int2_mk a, int2_mk b)
        {
